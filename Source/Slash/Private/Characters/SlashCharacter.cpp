...
void ASlashCharacter::BeginPlay()
{
	...
	if (PlayerController)
	{
		...
		SetPlayerEnhancedInput(PlayerController);
	}
	
}

void ASlashCharacter::SetPlayerEnhancedInput(APlayerController* PlayerController)
{
...
void ASlashCharacter::Move(const FInputActionValue& Value)
{
	...
	{
		//Set a debug message on screen to see if not receiving input	
		//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("Not receiving input"));
		return;
...
{
	Weapon->EquipItem(GetMesh(), FName("RightHandSocket"), this, this);
	CharacterState = ECharacterState::ECS_EquippedOneHandedWeapon;
